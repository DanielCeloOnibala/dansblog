		...
		<div class="container">
			...
			<div id="hot-post" class="row hot-post">
				...
				<div class="col-md-4 hot-post-right">
					<!-- post -->
					<div class="post post-thumb">
						<a class="post-img" href="blog-post.html"><img src="{{ asset('public') }}/callie/img/hot-post-2.jpg" alt=""></a>
						<div class="post-body">
							<div class="post-category">
								<a href="category.html">Lifestyle</a>
							</div>
					...
					<!-- post -->
					<div class="post post-thumb">
						<a class="post-img" href="blog-post.html"><img src="{{ asset('public') }}/callie/img/hot-post-3.jpg" alt=""></a>
						<div class="post-body">
							<div class="post-category">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="section-title">
								<h2 class="title">Postingan Artikel Terbaru</h2>
							</div>
						</div>
						<!-- post -->
				...
				<div class="col-md-4">
					...
					<div class="aside-widget text-center">
						<a href="#" style="display: inline-block;margin: auto;">
							<img class="img-responsive" src="{{ asset('public') }}/callie/img/ad-3.jpg" alt="">
						</a>
					</div>
					<!-- /ad widget -->
				...
				<div class="col-md-3">
					<div class="footer-widget">
						<div class="footer-logo">
							<a href="index.html" class="logo"><img src="{{ asset('public') }}/callie/img/logo-alt.png" alt=""></a>
						</div>
